    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Choose the allocation algorithm for comparison
          </p>
        </div>
      ...
      {isComparisonMode && (
        <Alert className="bg-green-50 border-green-200">
          ...
          <AlertDescription>
            Comparison mode is active. Use the simulation and comparison
            endpoints to analyze different allocation strategies.
          </AlertDescription>
        </Alert>
      )}
              ...
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <div
                      className={`p-2 rounded-lg ${algorithm.color} text-white`}
                    >
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            This algorithm preference will be used for allocations. The backend
            manages the actual strategy selection.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex items-center gap-4">
            <div
              className={`p-3 rounded-lg ${
                algorithms.find((a) => a.id === selectedAlgorithm)?.color
              } text-white`}
            >
              {(() => {
                const Icon =
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Expected efficiency:{" "}
                {algorithms.find((a) => a.id === selectedAlgorithm)?.efficiency}
              </p>
            </div>
          </div>
        </CardContent>
